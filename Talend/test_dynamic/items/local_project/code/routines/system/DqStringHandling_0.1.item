...
public class DqStringHandling {
     ...
     * 
     * {param} string("A.I.D.S") input: The string that will be checked for initials
     * 
     ...
     * 
     * {param} string("world") input: The string to make safe.
     * 
     ...
     * {Category} Data Quality
     * 
     * {param} string("world") input: The string to trim (can be null).
     * 
     ...
     * {Category} Data Quality
     * 
     * {param} string("hello") input: The string to concatenate (can be null). {param} string("world") input: The string
     * to concatenate (can be null). {param} char('|') input: the separator to be used in the concatenation of the
     * strings
     * 
     ...
     * {Category} Data Quality
     * 
     * {param} char('|') input: the separator to be used in the concatenation of the strings {param}
     * strings("hello","world") input: The string to concatenate (can be null).
     * 
     ...
     * {Category} User Defined
     * 
     * {param} string("text") input: The text to validate.
     * 
